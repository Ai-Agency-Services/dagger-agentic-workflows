...
class BuilderID(Scalar):
    """The `BuilderID` scalar type represents an identifier for an object
    of type Builder."""


class BuilderLlmcredentialsID(Scalar):
    """The `BuilderLlmcredentialsID` scalar type represents an identifier
    for an object of type BuilderLlmcredentials."""
...
class PullRequestAgentID(Scalar):
    """The `PullRequestAgentID` scalar type represents an identifier for
    an object of type PullRequestAgent."""


class ReporterID(Scalar):
    """The `ReporterID` scalar type represents an identifier for an object
    of type Reporter."""
...
class Binding(Type):
    ...
    def as_builder(self) -> "Builder":
        """Retrieve the binding value, as type Builder"""
        _args: list[Arg] = []
        _ctx = self._select("asBuilder", _args)
        return Builder(_ctx)

    def as_builder_llmcredentials(self) -> "BuilderLlmcredentials":
        """Retrieve the binding value, as type BuilderLlmcredentials"""
        _args: list[Arg] = []
        _ctx = self._select("asBuilderLlmcredentials", _args)
        return BuilderLlmcredentials(_ctx)
    ...
    def as_pull_request_agent(self) -> "PullRequestAgent":
        """Retrieve the binding value, as type PullRequestAgent"""
        _args: list[Arg] = []
        _ctx = self._select("asPullRequestAgent", _args)
        return PullRequestAgent(_ctx)

    def as_reporter(self) -> "Reporter":
        """Retrieve the binding value, as type Reporter"""
        _args: list[Arg] = []
        _ctx = self._select("asReporter", _args)
        return Reporter(_ctx)
...
@typecheck
class Builder(Type):
    """ Handles the setup of Dagger containers, prioritizing user's
    Dockerfile.  """

    def build_test_environment(self, source: "Directory", dockerfile_path: str, open_router_api_key: "Secret", provider: str, *, openai_api_key: "Secret | None" = None,) -> "Container":
        """
        ...
        _args = [
            ...
            Arg("openRouterApiKey", open_router_api_key),
            Arg("provider", provider),
            Arg("openaiApiKey", openai_api_key, None),
        ]
        _ctx = self._select("buildTestEnvironment", _args)
        return Container(_ctx)

    async def id(self) -> BuilderID:
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(BuilderID)

    def setup_pull_request_container(self, base_container: "Container", token: "Secret",) -> "Container":
        """
        Sets up the container for managing pull requests, starting from a base
        container.
...
@typecheck
class BuilderLlmcredentials(Type):
    """ Holds the base URL and API key for an LLM provider.  """

    async def id(self) -> BuilderLlmcredentialsID:
        """A unique identifier for this BuilderLlmcredentials.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(BuilderLlmcredentialsID)
...
class Container(Type):
    ...
    def build(self, context: "Directory", *, dockerfile: str | None = "Dockerfile", target: str | None = "", build_args: list[BuildArg] | None = None, secrets: "list[Secret] | None" = None, no_init: bool | None = False,) -> Self:
    ...
    async def up(self, *, ports: list[PortForward] | None = None, random: bool | None = False, args: list[str] | None = None, use_entrypoint: bool | None = False, experimental_privileged_nesting: bool | None = False, insecure_root_capabilities: bool | None = False, expand: bool | None = False, no_init: bool | None = False,) -> Void | None:
    ...
    def with_directory(self, path: str, directory: "Directory", *, exclude: list[str] | None = None, include: list[str] | None = None, owner: str | None = "", expand: bool | None = False,) -> Self:
    ...
    def with_exec(self, args: list[str], *, use_entrypoint: bool | None = False, stdin: str | None = "", redirect_stdout: str | None = "", redirect_stderr: str | None = "", expect: ReturnType | None = ReturnType.SUCCESS, experimental_privileged_nesting: bool | None = False, insecure_root_capabilities: bool | None = False, expand: bool | None = False, no_init: bool | None = False,) -> Self:
...
class Directory(Type):
    ...
    def docker_build(self, *, platform: Platform | None = None, dockerfile: str | None = "Dockerfile", target: str | None = "", build_args: list[BuildArg] | None = None, secrets: "list[Secret] | None" = None, no_init: bool | None = False,) -> Container:
    ...
    def filter(self, *, exclude: list[str] | None = None, include: list[str] | None = None,) -> Self:
    ...
    def terminal(self, *, cmd: list[str] | None = None, experimental_privileged_nesting: bool | None = False, insecure_root_capabilities: bool | None = False, container: Container | None = None,) -> Self:
...
class Env(Type):
    ...
    def with_builder_input(self, name: str, value: Builder, description: str,) -> Self:
        """Create or update a binding of type Builder in the environment
        ...
        value:
            The Builder value to assign to the binding
        description:
        ...
        _ctx = self._select("withBuilderInput", _args)
        return Env(_ctx)

    def with_builder_llmcredentials_input(self, name: str, value: BuilderLlmcredentials, description: str,) -> Self:
        """Create or update a binding of type BuilderLlmcredentials in the
        environment
        ...
        name:
            The name of the binding
        value:
            The BuilderLlmcredentials value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withBuilderLlmcredentialsInput", _args)
        return Env(_ctx)

    def with_builder_llmcredentials_output(self, name: str, description: str) -> Self:
        """Declare a desired BuilderLlmcredentials output to be assigned in the
        environment
        ...
        _ctx = self._select("withBuilderLlmcredentialsOutput", _args)
        return Env(_ctx)

    def with_builder_output(self, name: str, description: str) -> Self:
        """Declare a desired Builder output to be assigned in the environment
        ...
        _ctx = self._select("withBuilderOutput", _args)
        return Env(_ctx)
    ...
    def with_llm_input(self, name: str, value: "LLM", description: str,) -> Self:
    ...
    def with_pull_request_agent_input(self, name: str, value: "PullRequestAgent", description: str,) -> Self:
        """Create or update a binding of type PullRequestAgent in the environment
        ...
        name:
            The name of the binding
        value:
            The PullRequestAgent value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withPullRequestAgentInput", _args)
        return Env(_ctx)

    def with_pull_request_agent_output(self, name: str, description: str) -> Self:
        """Declare a desired PullRequestAgent output to be assigned in the
        environment
        ...
        _ctx = self._select("withPullRequestAgentOutput", _args)
        return Env(_ctx)

    def with_reporter_input(self, name: str, value: "Reporter", description: str,) -> Self:
        """Create or update a binding of type Reporter in the environment
        ...
        name:
            The name of the binding
        value:
            The Reporter value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withReporterInput", _args)
        return Env(_ctx)

    def with_reporter_output(self, name: str, description: str) -> Self:
        """Declare a desired Reporter output to be assigned in the environment
        ...
        _ctx = self._select("withReporterOutput", _args)
        return Env(_ctx)
...
class Function(Type):
    ...
    def with_arg(self, name: str, type_def: "TypeDef", *, description: str | None = "", default_value: JSON | None = None, default_path: str | None = "", ignore: list[str] | None = None, source_map: "SourceMap | None" = None,) -> Self:
...
@typecheck
class PullRequestAgent(Type):

    async def id(self) -> PullRequestAgentID:
        """A unique identifier for this PullRequestAgent.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(PullRequestAgentID)

    def run(self, container: Container, *, error_context: str | None = None, insight_context: str | None = None,) -> Container:
        """
        ...
        _args = [
            ...
            Arg("errorContext", error_context, None),
            Arg("insightContext", insight_context, None),
        ]
...
class Client(Root):
    ...
    def builder(self, config_file: File) -> Builder:
        """
        ...
        _ctx = self._select("builder", _args)
        return Builder(_ctx)

    def cache_volume(self, key: str, *, namespace: str | None = "",) -> CacheVolume:
    ...
    def git(self, url: str, *, keep_git_dir: bool | None = True, experimental_service_host: "Service | None" = None, ssh_known_hosts: str | None = "", ssh_auth_socket: "Socket | None" = None,) -> GitRepository:
    ...
    def load_builder_from_id(self, id: BuilderID) -> Builder:
        """Load a Builder from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadBuilderFromID", _args)
        return Builder(_ctx)

    def load_builder_llmcredentials_from_id(self, id: BuilderLlmcredentialsID) -> BuilderLlmcredentials:
        """Load a BuilderLlmcredentials from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadBuilderLlmcredentialsFromID", _args)
        return BuilderLlmcredentials(_ctx)
    ...
    def load_pull_request_agent_from_id(self, id: PullRequestAgentID) -> PullRequestAgent:
        """Load a PullRequestAgent from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadPullRequestAgentFromID", _args)
        return PullRequestAgent(_ctx)

    def load_reporter_from_id(self, id: ReporterID) -> "Reporter":
        """Load a Reporter from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadReporterFromID", _args)
        return Reporter(_ctx)
    ...
    def pull_request_agent(self, config_file: File) -> PullRequestAgent:
        """
        Create a PullRequestAgent instance with the given configuration and
        container.
        ...
        _ctx = self._select("pullRequestAgent", _args)
        return PullRequestAgent(_ctx)
    ...
    def reporter(self, name: str) -> "Reporter":
        ...
        _ctx = self._select("reporter", _args)
        return Reporter(_ctx)
...
class Reporter(Type):
    ...
    async def get_code_under_test(self, coverage_html: str) -> str:
        ...
        """
        _args = [
            Arg("coverageHtml", coverage_html),
        ]
        _ctx = self._select("getCodeUnderTest", _args)
        return await _ctx.execute(str)

    async def get_coverage_html(self, html_report_path: str, test_container: Container,) -> str:
        """
        ...
        """
        _args = [
            Arg("htmlReportPath", html_report_path),
            Arg("testContainer", test_container),
        ]
        _ctx = self._select("getCoverageHtml", _args)
        return await _ctx.execute(str)

    def get_coverage_reports(self, container: Container, report_directory: str,) -> File:
        """
        Extract coverage data from the HTML input and create a JSON file with
        the data

        Parameters
        ----------
        container:
            The container to extract the coverage reports from. Must be of
            type Dagger.Container
        report_directory:
            The directory to extract the coverage reports from. Must be of
            type str
        """
        _args = [
            Arg("container", container),
            Arg("reportDirectory", report_directory),
        ]
        _ctx = self._select("getCoverageReports", _args)
        return File(_ctx)

    async def id(self) -> ReporterID:
        ...
        -------
        ReporterID
            The `ReporterID` scalar type represents an identifier for an
            object of type Reporter.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(ReporterID)

    async def parse_test_results(self, result_json: str) -> str:
        """
        Parse the test results JSON file and return a str with the failed
        tests

        Parameters
        ----------
        result_json:
            The test results in JSON format. Must be of type str
        ...
        _ctx = self._select("parseTestResults", _args)
        return await _ctx.execute(str)

    async def validate_config(self, config: str) -> Void | None:
        """
        ...
        _ctx = self._select("validateConfig", _args)
        await _ctx.execute()
...
class TypeDef(Type):
    ...
    def with_enum_value(self, value: str, *, description: str | None = "", source_map: SourceMap | None = None,) -> Self:
    ...
    def with_field(self, name: str, type_def: Self, *, description: str | None = "", source_map: SourceMap | None = None,) -> Self:
    ...
    def with_object(self, name: str, *, description: str | None = "", source_map: SourceMap | None = None,) -> Self:
