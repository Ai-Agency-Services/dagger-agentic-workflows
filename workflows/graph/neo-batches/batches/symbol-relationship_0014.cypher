...
AND s1.name = "Spotlight" AND s1.filepath = "/app/src/components/ui/spotlight.tsx"
MATCH (s2) WHERE (s2:Function OR s2:Class OR s2:Variable OR s2:Method OR s2:Interface) 
AND s2.name = "containerRef" AND s2.filepath = "/app/src/components/ui/spotlight.tsx"
MERGE (s1)-[:REFERENCES]->(s2);
...
AND s1.name = "Spotlight" AND s1.filepath = "/app/src/components/ui/spotlight.tsx"
MATCH (s2) WHERE (s2:Function OR s2:Class OR s2:Variable OR s2:Method OR s2:Interface) 
AND s2.name = "spotlightLeft" AND s2.filepath = "/app/src/components/ui/spotlight.tsx"
MERGE (s1)-[:REFERENCES]->(s2);
...
AND s1.name = "Spotlight" AND s1.filepath = "/app/src/components/ui/spotlight.tsx"
MATCH (s2) WHERE (s2:Function OR s2:Class OR s2:Variable OR s2:Method OR s2:Interface) 
AND s2.name = "spotlightTop" AND s2.filepath = "/app/src/components/ui/spotlight.tsx"
MERGE (s1)-[:REFERENCES]->(s2);
