...
class Neo4jService:
    ...
    async def test_connection(self) -> str:
        """Test connection to Neo4j service and show database relationship statistics"""
        try:
            # Basic connection test
            connection_result = await self.run_query("RETURN 'Connected' AS result")
            ...
            # Get sample relationships (limited to 5 examples of each type)
